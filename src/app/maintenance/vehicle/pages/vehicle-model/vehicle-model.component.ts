...
import { SettingVehicleModel } from '../../interfaces/setting-vehicle-model.interface';
...
export class VehicleModelComponent {
  ...
  public setting!: SettingVehicleModel;
  public table!: Table;
  ...
  public save() {
    if (this.model.valid) {
      let object: VehicleModel = Object.assign({}, this.model.value);
