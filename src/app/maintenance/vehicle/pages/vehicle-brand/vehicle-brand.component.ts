...
import { SettingVehicleBrand } from '../../interfaces/setting-vehicle-brand.interface';
...
export class VehicleBrandComponent {
  ...
  public setting!: SettingVehicleBrand;
  public table!: Table;
  public model: FormGroup = new FormGroup({});
  public paged: FormGroup = new FormGroup({});

  constructor(
    private bsModalService: BsModalService
    , private spinner: NgxSpinnerService
    , private formBuilder: FormBuilder
    , private service: VehicleBrandService
  ) { }
  ...
  public save() {
    if (this.model.valid) {
      let object: VehicleBrand = Object.assign({}, this.model.value);
