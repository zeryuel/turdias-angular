...
import { SettingVehicle } from '../../../vehicle/interfaces/setting-vehicle.interface';
...
export class ModalVehicleComponent {
  ...
  public value: { id: number, plate: string, name: string };
  ...
  constructor(
    ...
    this.table = {
      ...
      lstColumn: [
        ...
        { name: 'PLACA', width: '10%', style: 'text-center' },
        { name: 'NOMBRE', width: '40%', style: 'text-left' },
        { name: 'TIPO', width: '15%', style: 'text-left' },
        { name: 'MODELO', width: '15%', style: 'text-left' },
