...
export class ModalMechanicComponent {
  ...
  public value: { id: number, fullName: string };
  ...
  constructor(
    ...
    this.paged = this.formBuilder.group({
      ...
      lstFilter: this.formBuilder.array(
        [
          this.formBuilder.group({ object: 'personal', column: 'documentNumber', value: '', operator: 'equal' }),
    ...
    this.table = {
      ...
      lstColumn: [
        ...
        { name: 'DNI', width: '15%', style: 'text-center' },
  ...
  public selectRecord(record: any) {
    ...
    this.value.fullName = record.fullName;
  }
