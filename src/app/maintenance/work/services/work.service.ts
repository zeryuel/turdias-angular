...
export class WorkService {
  ...
  private apiUrl: string = environment.apis.maintenance + 'work/';

  constructor(private http: HttpClient) { }

  public insert(resource: Work): Observable<Response<Work>> {
    return this.http.post<Response<Work>>(this.apiUrl + 'insert', resource, this.httpOptions);
  }

  public update(resource: Work): Observable<Response<Work>> {
    return this.http.post<Response<Work>>(this.apiUrl + 'update', resource, this.httpOptions);
  }

  public delete(resource: Work): Observable<Response<string>> {
  ...
  public findById(resource: Work): Observable<Response<Work>> {
    return this.http.post<Response<Work>>(this.apiUrl + 'find_by_id', resource, this.httpOptions);
  }
