...
export class ModalProductComponent {
  ...
  public value: {
    ...
    unitMeasure: { id: number, name: string }
  };
  ...
  constructor(
    ...
    this.table = {
      ...
      lstColumn: [
        ...
        { name: 'COD. ALT.', width: '10%', style: 'text-center' },
        { name: 'NOMBRE', width: '50%', style: 'text-left' },
        { name: 'MARCA', width: '10%', style: 'text-center' },
        { name: 'U. MEDIDA', width: '10%', style: 'text-center' }
      ],
      lstPageSize: [
        { id: 10, name: '10' },
        { id: 30, name: '30' },
  ...
  public selectRecord(record: any) {
    ...
    // this.value.itemBrand.id = record.itemBrand.id;
    // this.value.itemBrand.name = record.itemBrand.name;
  }
