...
import { SettingCostCenter } from './interfaces/setting-cost-center.interface';
...
export class CostCenterComponent {
  ...
  public setting: SettingCostCenter;
  public table: Table;
    ...
    this.service.setting(object).subscribe({
      next: (response) => {
        if (response !== null && response.status == 'ok') {
          ...
          this.setting.lstCostCenterType = response.value.lstCostCenterType.value;
  ...
  public save() {
    if (this.model.valid) {
      let object: CostCenter = Object.assign({}, this.model.value)
