...
import { SupplierActivityService } from '../../services/economic-activity.service';
import { EconomicActivity } from '../../interfaces/economic-activity.interface';
import { SettingSupplierActivity } from '../../interfaces/setting-supplier-activity.interface';
...
export class EconomicActivityComponent {
  ...
  public setting: SettingSupplierActivity;
  public table: Table;
  ...
  constructor(
    ...
    , private service: SupplierActivityService
  ) {
  ...
  public save() {
    if (this.model.valid) {
      let object: EconomicActivity = Object.assign({}, this.model.value);
