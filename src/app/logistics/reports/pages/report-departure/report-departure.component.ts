...
@Component({
  selector: 'app-report-departure',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, NgxSpinnerModule, BsDatepickerModule, FormsModule],
  templateUrl: './report-departure.component.html'
})
export class ReportDepartureComponent {
  ...
  constructor(
    ...
    this.model = this.formBuilder.group({
      store: this.formBuilder.group({ id: '', name: '' }),
  ...
  public generateReport() {
    if (this.model.valid) {
        ...
        lstFilter: [
          {
            object: 'store',
            column: 'id',
            value: this.model.get('store')?.get('id')?.value,
            operator: 'equal'
          },
          {
            object: 'costCenter',
      ...
      this.spinner.show()
      this.service.departure(paged).subscribe({
        next: (response) => {
  ...
  private generateExcel(objeto: any ) {
    ...
    let arr: any = [
      { col1: { v: "CODIGO", t: "s", s: { font: { bold: true }, alignment: { horizontal: "center" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } }  } },
        ...
        col8: { v: "CENTRO DE COSTOS", t: "s", s: { font: { bold: true }, alignment: { wrapText: true, horizontal: "center" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } }  } },
        col9: { v: "CANTIDAD", t: "s", s: { font: { bold: true }, alignment: { wrapText: true, horizontal: "center" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } }  } },
        col10: { v: "VALOR UNT.", t: "s", s: { font: { bold: true }, alignment: { wrapText: true, horizontal: "center" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } }  } },
        col11: { v: "PERSONAL ENT.", t: "s", s: { font: { bold: true }, alignment: { wrapText: true, horizontal: "center" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } }  } },
        col12: { v: "OBSERVACION", t: "s", s: { font: { bold: true }, alignment: { wrapText: true, horizontal: "center" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } }  } }
      }
    ];
      ...
      arr.push(
        {
          ...
          col10: { v: item.value_10, t: "s", s: { alignment: { horizontal: "center" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } } }},
          col11: { v: item.value_11, t: "s", s: { alignment: { horizontal: "left" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } } }},
          col12: { v: item.value_12, t: "s", s: { alignment: { horizontal: "left" }, border: { top: { style: "thin", color: {rgb: "000000"} }, bottom: { style: "thin", color: {rgb: "000000"} }, left: { style: "thin", color: {rgb: "000000"} }, right: { style: "thin", color: {rgb: "000000"} } } }}
        }
      );
     }
    ...
    worksheet["!cols"] = [ { wch: 10 }, { wch: 16 }, { wch: 20 }, { wch: 60 }, { wch: 20 }, { wch: 20 }, { wch: 20 }, { wch: 20 }, { wch: 25 }, { wch: 15 }, { wch: 15 }, { wch: 40 }, { wch: 30 } ];

    XLSX.utils.sheet_add_aoa(worksheet, Heading);
    XLSX.utils.sheet_add_json(worksheet, arr, { origin: 'B8', skipHeader: true });
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Hoja1');

    XLSX.writeFile(workbook, 'Reporte_salidas' + '_' + new  Date().getTime() + '.xlsx');
  }
  ...
  public searchStore() {
    ...
    this.bsModalRef.content.response.subscribe((response: CostCenter) => {
      if (response != null) {
        this.model.get('store')?.get('id')?.setValue(response.id);
        this.model.get('store')?.get('name')?.setValue(response.name);
      }
    });
  }
  ...
  public cleanStore() {
    this.model.get('store')?.get('id')?.setValue('');
    this.model.get('store')?.get('name')?.setValue('');
  }
