...
import { SettingUnitMeasure } from '../../interfaces/setting-unit-measure';
...
export class UnitMeasureComponent {
  ...
  public save() {
    if (this.model.valid) {
      let object: UnitMeasure = Object.assign({}, this.model.value);

      object.id = object.id.toString() == '' ? 0 : object.id;
      object.name = object.name.toUpperCase();
      object.sunatCode = object.sunatCode.toUpperCase();
