...
export class InventoryService {
  ...
  private apiUrl: string = environment.apis.logistics + 'inventory/';


  public update(resource: Inventory): Observable<Response<Inventory>> {
    return this.http.post<Response<Inventory>>(this.apiUrl + 'update', resource, this.httpOptions);
  }
  ...
  public findById(resource: Inventory): Observable<Response<Inventory>> {
    return this.http.post<Response<Inventory>>(this.apiUrl + 'find_by_id', resource, this.httpOptions);
  }
