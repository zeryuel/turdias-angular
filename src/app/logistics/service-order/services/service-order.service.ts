...
export class ServiceOrderService {
  ...
  private apiUrl: string = environment.apis.logistics + 'service-order/';

  constructor(private http: HttpClient) { }

  public insert(resource: ServiceOrder): Observable<Response<string>> {
    return this.http.post<Response<string>>(this.apiUrl + 'insert', resource, this.httpOptions);
  }

  public update(resource: ServiceOrder): Observable<Response<string>> {
    return this.http.post<Response<string>>(this.apiUrl + 'update', resource, this.httpOptions);
  }

  public delete(resource: ServiceOrder): Observable<Response<string>> {
  ...
  public findById(resource: ServiceOrder): Observable<Response<ServiceOrder>> {
    return this.http.post<Response<ServiceOrder>>(this.apiUrl + 'find_by_id', resource, this.httpOptions);
  }
