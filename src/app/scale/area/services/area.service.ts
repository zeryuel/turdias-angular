...
export class AreaService {
  ...
  private apiUrl: string = environment.apis.scale + 'area/';

  constructor(private http: HttpClient) { }

  public insert(resource: Area): Observable<Response<Area>> {
    return this.http.post<Response<Area>>(this.apiUrl + 'insert', resource, this.httpOptions);
  }

  public update(resource: Area): Observable<Response<Area>> {
    return this.http.post<Response<Area>>(this.apiUrl + 'update', resource, this.httpOptions);
  }

  public delete(resource: Area): Observable<Response<string>> {
  ...
  public findById(resource: Area): Observable<Response<Area>> {
    return this.http.post<Response<Area>>(this.apiUrl + 'find_by_id', resource, this.httpOptions);
  }
