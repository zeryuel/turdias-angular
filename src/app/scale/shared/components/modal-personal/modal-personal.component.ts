...
export class ModalPersonalComponent {
  ...
  public value: { id: number, documentNumber: '', fullName: string };
  ...
  constructor(
    ...
    this.value = { id: 0, documentNumber: '', fullName: '' };
    ...
    this.table = {
      ...
      lstColumn: [
        ...
        { name: 'NUMERO DOC', width: '15%', style: 'text-center' },
        { name: 'NOMBRES Y APELLIDOS', width: '70%', style: 'text-left' }
      ],
      lstPageSize: [
        { id: 10, name: '10' },
        { id: 30, name: '30' },
  ...
  public selectRecord(record: any) {
    ...
    this.value.documentNumber = record.documentNumber;
    this.value.fullName = record.name + ' '+ record.lastName + ' ' + record.motherLastName;
  }
